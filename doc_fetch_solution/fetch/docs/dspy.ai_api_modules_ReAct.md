...
](https://github.com/stanfordnlp/dspy/blob/main/docs/docs/api/modules/ReAct.md)
# dspy.ReAct
## 
...
The signature of the module, which defines the input and output of the react module.
required
tools
list
[
...
A list of functions, callable objects, or dspy.Tool instances.
required
max_iters
Optional
[
