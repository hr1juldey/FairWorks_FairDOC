...
**Source:** https://dspy.ai/learn/programming/language/models
...
```
If you run into errors, please refer to the LiteLLM Docs to verify if you are using the same variable names/following the right procedure.
