...
**Source:** https://dspy.ai/tutorials/multihop/search
...
](https://github.com/stanfordnlp/dspy/blob/main/docs/docs/tutorials/multihop_search/index.ipynb)
...
lm = dspy.LM('
/Llama-3.1-8B-Instruct', max_tokens=3000)
gpt4o = dspy.LM('openai/gpt-4o', max_tokens=3000)
