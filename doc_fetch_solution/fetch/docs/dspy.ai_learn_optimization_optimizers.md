...
4. 
GEPA: Uses LM's to reflect on the DSPy program's trajectory, to identify what worked, what didn't and propose prompts addressing the gaps. Additionally, GEPA can leverage domain-specific textual feedback to rapidly improve the DSPy program.
...
1. [Ensemble](../../../api/optimizers/Ensemble/): Ensembles a set of DSPy programs and either uses the full set or randomly samples a subset into a single program.
...
- If you prefer to do instruction optimization only (i.e. you want to keep your prompt 0-shot), use MIPROv2 [configured for 0-shot optimization](../../../api/optimizers/MIPROv2/). 
...
[ 8](#__codelineno-1-8)
[ 9](#__codelineno-1-9)
[10](#__codelineno-1-10)
[11](#__codelineno-1-11)
[12](#__codelineno-1-12)
[13](#__codelineno-1-13)
[14](#__codelineno-1-14)
[15](#__codelineno-1-15)
```
```
import dspy
...
[ 8](#__codelineno-2-8)
[ 9](#__codelineno-2-9)
[10](#__codelineno-2-10)
[11](#__codelineno-2-11)
```
```
...
[ 8](#__codelineno-4-8)
[ 9](#__codelineno-4-9)
[10](#__codelineno-4-10)
[11](#__codelineno-4-11)
[12](#__codelineno-4-12)
[13](#__codelineno-4-13)
[14](#__codelineno-4-14)
[15](#__codelineno-4-15)
```
```
import dspy
