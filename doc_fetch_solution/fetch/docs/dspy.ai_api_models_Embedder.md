...
**Source:** https://dspy.ai/api/models/Embedder
...
](https://github.com/stanfordnlp/dspy/blob/main/docs/docs/api/models/Embedder.md)
# dspy.Embedder
## 
...
|
Callable
The embedding model to use. This can be either a string (representing the name of the hosted embedding
...
batch_size
int
The batch size for processing inputs. If None, defaults to the batch_size set
during initialization.
None
caching
bool
Whether to cache the embedding response when using a hosted model. If None,
...
Additional keyword arguments to pass to the embedding model. These will override the default
